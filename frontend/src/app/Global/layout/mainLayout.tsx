    ...
    <header className='bg-gray-700 flex w-full items-center h-[20%]'>
      <div className="navbar items-center">
        ...
        <div className="navbar-center gap-20">
          <button className="btn btn-ghost text-2xl">문화센터</button>
          <button className="btn btn-ghost text-2xl">게시판</button>
          <button className="btn btn-ghost text-2xl">관리사무소</button>
        </div>
        <div className="navbar-end">
          ...
          <DropDown open={openDropDown} onClose={() => setOpenDropDown(false)} background="main" button="profileSettings" className="mt-[1px] text-black" defaultDriection={Direcion.DOWN} height={200} width={180} x={-100} y={5}>
            <a className="mt-0 btn btn-active btn-secondary text-black" href="/account/myProfile">
              <FontAwesomeIcon icon={faUser} />
              내 정보
            </a>
            <a className="mt-1 btn btn-active btn-secondary text-black" href="/account/profile">
