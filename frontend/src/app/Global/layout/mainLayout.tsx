    ...
    <main id='main' className={'bg-black h-full w-[1920px] flex flex-col items-center relative ' + className}>
      ...
      <header className='rounded-b-xl bg-gray-700 flex w-full items-center h-[80px]'>
        <div className="navbar items-center">
          ...
          <DropDown open={centerHover} onClose={() => !setCenterHover} className='border-x-1 border-b-1 border-black rounded-b-xl bg-gray-700' background='main' button='center' defaultDriection={Direcion.DOWN} height={defaultHeight} width={180} y={14} x={-30}>
